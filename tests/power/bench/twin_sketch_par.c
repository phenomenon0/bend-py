// The C twin of the sketch_par bench, and the same program as twin_sketch.c:
// the fork has to land on the sequential answer, so the sequential answer is
// what it is compared against. 12,800,000 HyperLogLog updates over 64
